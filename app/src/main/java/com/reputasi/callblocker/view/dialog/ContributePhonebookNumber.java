...
/**
 * Created by vikraa on 8/30/2015.
 */
public class ContributePhonebookNumber extends BaseDialog implements ManagerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FragmentPagerPhonebook listPhonebookNumber = new FragmentPagerPhonebook();
        listPhonebookNumber.setListener(this);
        FragmentPagerCategory listCategoryFragment = new FragmentPagerCategory();
        listCategoryFragment.setListener(this);
        Fragment[] pages = new Fragment[] { listPhonebookNumber, listCategoryFragment};
    ...
    public void onEvent(Object ob, int id) {
        if (id == EVENT_CONTRIBUTE_THUMBS_DOWN || id == EVENT_CONTRIBUTE_THUMBS_UP) {
            ...
            mContributeMap.put(KEY_CONTRIBUTE_OWNER_NAME, ContactManager.getInstance().getContactBookName(mContributeMap.get(KEY_CONTRIBUTE_PHONE_NUMBER)));
    ...
    public static class AdapterPhonebook extends ArrayAdapter<ContactBookItem> {
        private Context mContext;
        private List<ContactBookItem> mValues;
        private ManagerListener mListener;

        public AdapterPhonebook(Context context, List<ContactBookItem> values) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.mNumber.setText(mValues.get(position).getContactNumber());
            /*SimpleDateFormat sdf = new SimpleDateFormat("dd MMMM yyyy");
            Date date = new Date(mValues.get(position).getContactName());
            String callDate = sdf.format(date);*/
            holder.mInfo.setText(mValues.get(position).getContactName());
            ...
            holder.mThumbUp.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        mListener.onEvent(mValues.get(position).getContactNumber(), EVENT_CONTRIBUTE_THUMBS_UP);
                    }
                }
            });
            ...
            holder.mThumbDown.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mListener != null) {
                        mListener.onEvent(mValues.get(position).getContactNumber(), EVENT_CONTRIBUTE_THUMBS_DOWN);
                    }
                }
            });
    ...
    public static class FragmentPagerPhonebook extends Fragment implements ManagerListener {

        private ManagerListener mListener;
        private ListView mListPhonebook;

        @Nullable
        @Override
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View v = inflater.inflate(R.layout.dialog_pager_input_internal, null);
            mListPhonebook = (ListView)v.findViewById(R.id.lv_internal);
        ...
        public void onPostBackgroundTask(Object ob, int id) {
            switch (id) {
                case ContactManager.SYNCHRONIZE_CONTACT_LOCAL_DATABASE:
                    AdapterPhonebook adapter = new AdapterPhonebook(GlobalApplication.getContext(), (List<ContactBookItem>)ob);
                    adapter.setListener(mListener);
                    mListPhonebook.setAdapter(adapter);
                    break;
                default:
                    break;
            }
