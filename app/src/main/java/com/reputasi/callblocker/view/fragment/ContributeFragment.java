 ...
 */
public class ContributeFragment extends ReputasiTabPager {
    private Fragment[] mPagers;

    public ContributeFragment prepared(Activity activity) {
        mPagers = new Fragment[] { new ContributeContentsFragment() };
        setup(activity.getResources().getStringArray(R.array.contribute_tab), mPagers, new CustomPagerListener() {
            @Override
